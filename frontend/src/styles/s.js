...
export const s = {
  ...
  protoTag: { position: "fixed", bottom: 10, right: 12, fontSize: 10, letterSpacing: .3, color: T.inkSoft, background: "#fff", border: `1px solid ${T.line}`, padding: "4px 9px", borderRadius: 20, opacity: .9 },
  ...
  loginCard: { width: "100%", maxWidth: 380, background: "#fff", borderRadius: 20, padding: 34, boxShadow: "0 20px 50px rgba(20,40,55,.12)" },

  sidebar: { background: "#fff", borderRight: `1px solid ${T.line}`, display: "flex", flexDirection: "column", position: "sticky", top: 0, height: "100vh", transition: "width .22s cubic-bezier(.4,0,.2,1)", overflow: "hidden" },
  collapseBtn: { width: 30, height: 30, borderRadius: 8, display: "grid", placeItems: "center", background: "#fff", border: `1px solid ${T.line}` },
  ...
  topbar: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "16px clamp(16px,3vw,30px)", background: "#fff", borderBottom: `1px solid ${T.line}`, position: "sticky", top: 0, zIndex: 20 },
  ...
  profileMenu: { position: "absolute", top: 46, right: 0, width: 240, background: "#fff", border: `1px solid ${T.line}`, borderRadius: 14, padding: 14, boxShadow: "0 16px 40px rgba(20,40,55,.16)", zIndex: 30 },
  ...
  card: { background: "#fff", border: `1px solid ${T.line}`, borderRadius: 16, padding: 20 },
  ...
  kpiCard: { background: "#fff", border: `1px solid ${T.line}`, borderRadius: 16, padding: 18 },
  ...
  search: { display: "flex", alignItems: "center", gap: 8, background: "#fff", border: `1px solid ${T.line}`, borderRadius: 10, padding: "0 12px", height: 40 },
  ...
  campCard: { background: "#fff", border: `1px solid ${T.line}`, borderRadius: 16, padding: 18 },
  tplGrid: { display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(210px,1fr))", gap: 10 },
  tplPick: { textAlign: "left", background: "#fff", border: `1px solid ${T.line}`, borderRadius: 12, padding: 12, cursor: "pointer" },
  ...
  planUpgrade: { background: "#fff", color: T.primaryDark, fontWeight: 700, fontSize: 14, padding: "11px 18px", borderRadius: 11 },
  ...
  volCard: { background: "#fff", border: `1px solid ${T.line}`, borderRadius: 14, padding: 14 },
  ...
  textarea: { width: "100%", border: `1px solid ${T.line}`, borderRadius: 12, padding: 12, fontSize: 14, lineHeight: 1.5, resize: "vertical", color: T.ink, background: "#fff" },
  ...
  channelCard: { display: "flex", alignItems: "center", gap: 12, background: "#fff", border: `1px solid ${T.line}`, borderRadius: 14, padding: 14, transition: "all .15s", width: "100%" },
  channelIcon: { width: 40, height: 40, borderRadius: 11, display: "grid", placeItems: "center", flexShrink: 0 },
  slaCard: { background: "#fff", border: `1px solid ${T.line}`, borderRadius: 14, padding: 16 },

  fieldLabel: { display: "block", fontSize: 12.5, fontWeight: 600, color: T.ink, marginBottom: 7 },
  input: { width: "100%", height: 42, border: `1px solid ${T.line}`, borderRadius: 10, padding: "0 13px", fontSize: 14, color: T.ink, background: "#fff", transition: "all .15s" },
  select: { height: 40, border: `1px solid ${T.line}`, borderRadius: 10, padding: "0 12px", fontSize: 13.5, color: T.ink, background: "#fff" },
  ...
  btnGhost: { background: "#fff", color: T.ink, fontWeight: 700, fontSize: 14, padding: "11px 18px", borderRadius: 11, border: `1px solid ${T.line}` },
  btnGhostSm: { background: "#fff", color: T.ink, fontWeight: 700, fontSize: 13, padding: "8px 13px", borderRadius: 9, border: `1px solid ${T.line}`, display: "inline-flex", alignItems: "center", gap: 6 },
  ...
  modal: { position: "relative", background: "#fff", borderRadius: 18, padding: 24, width: "min(460px,100%)", boxShadow: "0 20px 60px rgba(0,0,0,.2)", maxHeight: "92vh", overflowY: "auto" },
  ...
  toast: { position: "fixed", bottom: 24, left: "50%", transform: "translateX(-50%)", background: "#fff", color: T.ink, fontWeight: 600, fontSize: 13.5, padding: "12px 18px", borderRadius: 12, boxShadow: "0 10px 30px rgba(20,40,55,.18)", zIndex: 60 },
};
