    ...
    <div style={s.root}>
      ...
      <div style={s.main}>
        ...
        <div style={s.content} key={view}>
          ...
          {view === "templates" && <AcessoRestrito liberado={souAdminOuGestor}><Templates templates={templates} setTemplates={setTemplates} objetivos={objetivos} onCriarObjetivo={criarObjetivoHandler} objetivoObjetos={objetivoObjetos} onExcluirObjetivo={excluirObjetivoHandler} usuario={usuario} camposCustomizados={camposCustomizados} showToast={showToast} /></AcessoRestrito>}
