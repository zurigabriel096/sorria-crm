...
export function Logo({ size = 22, light, angry, markOnly }) {
  ...
  return (
    <span className="notranslate" translate="no" style={{ display: "inline-flex" }}>
      <svg width={w} height={h} viewBox={markOnly ? "0 0 40 40" : "0 0 168 40"} fill="none" translate="no" role="img" aria-label="Sorr.ia" className={angry ? "logoShake" : ""} style={{ transformOrigin: "18px 20px" }}>
